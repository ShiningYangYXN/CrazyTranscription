...
console.print("Version [blue bold]2.2.1.2 (Arctic Wolf)[/blue bold], made with [red bold]love[/red bold] by [link=https://github.com/ShiningYangYXN]Shining Yang[/link]")
console.print("Visit [link=https://github.com/ShiningYangYXN/CrazyTranscription]https://github.com/ShiningYangYXN/CrazyTranscription[/link] for project updates.")
while True:
    mode=''
    ...
    if mode=='1':
        ...
        while mode!='#':
            ...
            if mode in ['1','2','3','4','5','6']:
                ...
                text=''
                console.print(f'[blue bold]Latin to {modeNames[mode]}[/blue bold] Mode [green]selected[/green]. [red bold]Type \'#\' to exit.[/red bold]')
                while text!='#':
                    text=console.input("[blue bold]Input your text to be transcribed:\n[/blue bold]")
        ...
        console.print("[blue bold]Reverse Transcription Mode.[/blue bold] [red bold]Type \'#\' to exit.[/red bold]")
        text=''
        while text!='#':
            text=console.input("[blue bold]Input your text to be transcribed:\n[/blue bold]")
